...
urlpatterns = [
    ...
    path('transactions/update-transactions/<str:pk>/', updateTransactionView , name='transaction'),
    path('transactions/updatePartial/', update_partialTransactionView , name='transaction'),
    path('transactions/delete-transaction/<str:pk>/', deleteTransactionView , name='transaction'),
